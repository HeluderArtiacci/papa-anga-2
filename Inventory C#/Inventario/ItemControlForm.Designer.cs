namespace Inventario
{
    partial class ItemControlForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PrincipalPanel.Controls.Add(this.provLabel);
            this.PrincipalPanel.Controls.Add(this.label13);
            this.PrincipalPanel.Controls.Add(this.manuLabel);
            this.PrincipalPanel.Controls.Add(this.label11);
            this.PrincipalPanel.Controls.Add(this.DescTextBox);
            this.PrincipalPanel.Controls.Add(this.label10);
            this.PrincipalPanel.Controls.Add(this.sellPriceLabel);
            this.PrincipalPanel.Controls.Add(this.label8);
            this.PrincipalPanel.Controls.Add(this.priceLabel);
            this.PrincipalPanel.Controls.Add(this.label6);
            this.PrincipalPanel.Controls.Add(this.stockLabel);
            this.PrincipalPanel.Controls.Add(this.label3);
            this.PrincipalPanel.Controls.Add(this.codeLabel);
            this.PrincipalPanel.Controls.Add(this.nameLabel);
            ...
            this.itemPicture.Location = new System.Drawing.Point(719, 54);
